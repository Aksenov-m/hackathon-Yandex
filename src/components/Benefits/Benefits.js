...
const Benefits = () => (
    ...
    <div class ="benefits__box">
      ...
      <ul class='benefits__list'>
        ...
        <BenefitCard title={'Развивать личный бренд'} about={'Публикуйте статьи в нашем блоге и выступайте на\u00A0мероприятиях, чтобы больше людей узнали о вас'} style={'benefits__icon_3'} />
