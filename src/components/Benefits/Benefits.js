...
const Benefits = () => (
    ...
    <div class ="benefits__box">
      ...
      <ul class='benefits__list'>
        ...
        <BenefitCard title={'Учиться новому'} about={'Вы узнаете, как давать обратную связь, выступать на публике и мотивировать людей'} style={'benefits__icon_2'} />
        ...
        <BenefitCard title={'Иметь доход от 35 до 50 тысяч ₽ в месяц'} about={'Удаленно, 2–3 часа в день, график выбираете сами'} style={'benefits__icon_5'} />
        <BenefitCard title={'Менять жизнь людей к лучшему'} about={'вы сможете стать старшим наставником или сеньор-ревьювером'} style={'benefits__icon_6'} />
      </ul>
